...
export default function Product({ product, sizeReviews: initialSizeValue }) {
    const [sizeReviews, setSizeReviews] = useState(initialSizeValue);
    ...
    async function handleSubmit(e) {
        ...
        setSizeReviews((pre) => [newSizeReview, ...pre]);
    }
                        ...
                        <form
                            ...
                            <label className={styles.label}>
                                ...
                                <Dropdown
                                    ...
                                    options={[
                                        {
                                            label: sizeReviewLabels.sex["male"],
                                            value: "male",
                                        },
                                        {
                                            label: sizeReviewLabels.sex[
                                                "female"
                                            ],
                                            value: "female",
                                        },
                            ...
                            <label className={styles.label}>
                                ...
                                <Dropdown
                                    ...
                                    options={[
                                        {
                                            label: sizeReviewLabels.fit[
                                                "small"
                                            ],
                                            value: "small",
                                        },
                                        {
                                            label: sizeReviewLabels.fit["good"],
                                            value: "good",
                                        },
                                        {
                                            label: sizeReviewLabels.fit["big"],
                                            value: "big",
                                        },
                                    ]}
                                    onChange={handleChange}
